    ...
    <div class="container">
        <div class="row py-4 mt-4 align-items-center">
            ...
            <div class="col-md-5 pr-lg-5 mb-5 mb-md-0">
                ...
                <p class="font-italic text-muted mb-0">para seguir ayudando como mentor</p>
            </div>

            <!-- Registeration Form -->
            <div class="col-md-3 col-lg-6 ml-auto">
                <form action="<?=base_url('loguear')?>">
                    <div class="row">
                        ...
                        <div class="text-center w-100">
                            <p class="text-muted font-weight-bold">¿Olvidaste tu contraseña? 
                                <a href="#" class="text-primary ml-2">Ayuda</a></p>
                        </div>
